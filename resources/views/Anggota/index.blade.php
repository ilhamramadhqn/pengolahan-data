                  ...
                  <table class="table table-striped">
                    ...
                    @foreach($data as $d)
                      <tr>
                        ...
                        <td>{{$d->no}}</td>
                        <td>
                          <button href="" class="edit btn btn-icon btn-primary btn-sm editFk"><i class="fas fa-edit"></i></button>
                          <button href="" class="btn btn-icon btn-danger btn-sm deleteFk"><i class="far fa-trash-alt text-white" data-feather="delete"></i></button>
                        </td>
                      </tr>
                    @endforeach
                    </tbody>
